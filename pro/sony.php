...
<a href="details.html" class="details">details</a> </div>
  ...
  <div id="main_content">
    ...
    <div class="center_content">
      <div class="center_title_bar">Sony products</div>
      <div class="prod_box">
        <div class="top_prod_box"></div>
        <div class="center_prod_box">
          <div class="product_title"></div>
          <div class="product_img"><a href="details.html"><img src="images/ww.jpg" alt="" width="152" height="106" border="0" /></a></div>
          <div class="prod_price"><span class="reduce">350$</span> <span class="price">270$</span></div>
        </div>
      ...
      <div class="prod_box">
        ...
        <div class="center_prod_box">
          <div class="product_title"></div>
          <div class="product_img"><a href="details.html"><img src="images/zz.jpg" alt="" width="153" height="104" border="0" /></a></div>
      ...
      <div class="prod_box">
        ...
        <div class="center_prod_box">
          ...
          <div class="product_img"><a href="details.html"><img src="images/nnn.jpg" alt="" width="166" height="110" border="0" /></a></div>
          <div class="prod_price"><span class="reduce">350$</span> <span class="price">270$</span></div>
        </div>
        <div class="bottom_prod_box"></div>
        <div class="prod_details_tab"> <a href="http://all-free-download.com/free-website-templates/" title="header=[Add to cart] body=[&nbsp;] fade=[on]"><img src="images/cart.gif" alt="" border="0" class="left_bt" /></a><a href="http://all-free-download.com/free-website-templates/" title="header=[Gifts] body=[&nbsp;] fade=[on]"><img src="images/favorites.gif" alt="" border="0" class="left_bt" /></a> <a href="details.html" class="prod_details">details</a> </div>
