...
<div id="main_container">
  <div class="top_bar">
    <div class="top_search">
      <div class="search_text"><a href="">dvanced Search</a></div>
...
<a href="http://all-free-download.com/free-website-templates/" class="details">details</a> </div>
  ...
  <div id="main_content">
    ...
    <div class="center_content">
      <div class="center_title_bar">Admin Page</div>
...
//require("scripts/connect_to_mysql.class.php");
//$objCon=new Connect();
$obj=new add_product();
...
{
	$id=$_GET['delete'];
	echo "Do you want to delete the following product with an id of '$id'? "."<a href='indexAdmin.php?yes=$id'>yes</a>"." || "."<a href='indexAdmin.php?no=$id'>No</a>";
	exit;
...
$id =$obj->add($name,$price,$descrip,$category);
$newname="$id.jpg";
 ...
 <form action="" method="post">
          <table width="369" border="0">
            ...
            <tr>
              ...
              <td><p>&nbsp;</p>
              <p>
                <select name="Category"  value="<?php echo $arr_pro[3];?>">
            ...
            <tr>
              <td><label for="fileField">Upload image</label></td>
              <td><p>&nbsp;</p>
              <p>
